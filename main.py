"""
Audio Segment Tool — FastAPI Backend (fixed)
"""
...
# One thread pool for all blocking audio work
...
# ─── Blocking audio work (runs in thread pool) ────────────────────────────────
...
async def start_segmentation(req: SegmentRequest):
    ...
    # Submit blocking work to the thread pool — does NOT block the event loop
